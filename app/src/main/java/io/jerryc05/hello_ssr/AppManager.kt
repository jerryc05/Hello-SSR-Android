...
class AppManager : AppCompatActivity(), Toolbar.OnMenuItemClickListener
{
	...
	override fun onMenuItemClick(item: MenuItem): Boolean
	{
		...
		when (item.itemId)
		{
			...
			{
				val profiles = ShadowsocksApplication.Companion.app.profileManager.allProfiles
	...
	private fun loadApps()
	{
		...
		var tempAdapter: AppManager.AppsAdapter
		do
		{
	...
	private fun getApps(pm: PackageManager): MutableList<ProxiedApp>
	{
		if (!receiverRegistered)
		{
			...
			ShadowsocksApplication.Companion.app.registerReceiver(object : BroadcastReceiver()
														{
	...
	private inner class AppsAdapter : RecyclerView.Adapter<AppManager.AppViewHolder>()
	{
		...
		override fun onBindViewHolder(vh: AppManager.AppViewHolder, i: Int)
		{
			vh.bind(apps[i])
		}

		override fun onCreateViewHolder(vg: ViewGroup, viewType: Int): AppManager.AppViewHolder
		{
