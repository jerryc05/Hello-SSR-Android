...
class ShadowsocksApplication : Application() {
	companion object {
		...
		internal const val TAG = "ShadowsocksApplication"
		internal val EXECUTABLES = arrayOf(
		...
		internal val SIMPLIFIED_CHINESE = Locale.SIMPLIFIED_CHINESE
		internal val TRADITIONAL_CHINESE = Locale.TRADITIONAL_CHINESE
