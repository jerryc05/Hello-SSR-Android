package io.jerryc05.hello_ssr.utils
...
object Constants
{
	...
	object Action
	{
		const val SERVICE = "io.jerryc05.shadowsocksr.SERVICE"
		const val CLOSE = "io.jerryc05.shadowsocksr.CLOSE"
		const val QUICK_SWITCH = "io.jerryc05.shadowsocksr.QUICK_SWITCH"
		const val SCAN = "io.jerryc05.shadowsocksr.intent.action.SCAN"
		const val SORT = "io.jerryc05.shadowsocksr.intent.action.SORT"
	}
